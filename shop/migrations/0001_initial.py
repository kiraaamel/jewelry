    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, default='Италия', max_length=100, verbose_name='Страна производства')),
                ('image', models.ImageField(blank=True, help_text='Основное фото товара', null=True, upload_to=shop.models.product_image_upload_path, verbose_name='Главное фото')),
                ('image_2', models.ImageField(blank=True, null=True, upload_to=shop.models.product_image_upload_path, verbose_name='Дополнительное фото 2')),
                ('image_3', models.ImageField(blank=True, null=True, upload_to=shop.models.product_image_upload_path, verbose_name='Дополнительное фото 3')),
                ('image_4', models.ImageField(blank=True, null=True, upload_to=shop.models.product_image_upload_path, verbose_name='Дополнительное фото 4')),
                ('image_5', models.ImageField(blank=True, null=True, upload_to=shop.models.product_image_upload_path, verbose_name='Дополнительное фото 5')),
                ...
                ('weight', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Вес изделия (г)')),
                ('size', models.CharField(blank=True, help_text='Например: 16.5, 17, 18, S, M, L', max_length=50, verbose_name='Размер')),
                ...
                ('stone_weight', models.DecimalField(blank=True, decimal_places=2, help_text='Общий вес всех камней в каратах', max_digits=8, null=True, verbose_name='Вес камней (карат)')),
